...
We [absolutely](https://www.gurobi.com/) [have](https://github.com/scipopt/scip) [tools](https://developers.google.com/optimization/introduction) that can find provably optimal solutions in reasonable time.
There's no magic.
